    ...
    <div className={`${styles.flexCenter} flex-col bg-[#080A17]`} >
        ...
        <div className={`${styles.boxWidth} mt-4 mb-4 sm:mb-0 sm:mt-20`}> 
            <div className='flex flex-col sm:flex-row w-full mt-20 h-min sm:h-[180px] items-center gap-8 sm:gap-0'>
                    <motion.h1 className='font-poppins flex-1 font-semibold text-[38px] sm:text-[44px] text-gray-100 text-left'
                    initial={{
                        x:-300,
                        opacity:0,
                    }}
                    ...
                    viewport={{
                        once:true,
                    }}>We build bridges between <span className='font-poppins font-semibold text-[38px] sm:text-[44px] text-gray-400 text-left'>companies <br className='hidden sm:block'/>and customers.</span></motion.h1>
                    <motion.p className='font-poppins flex-1 font-normal text-[16px] text-gray-300 text-left'
                    initial={{
                        x:300,
                        opacity:0,
                    }}
            ...
            <div className='flex flex-col sm:flex-row w-full my-20 gap-12 sm:gap-4'>
                ...
                viewport={{
                    ...
                    <h1 className='font-poppins font-semibold text-[34px] sm:text-[44px] text-gray-200 text-left lowercase'>Forging the Future with Exceptional Software Solutions</h1>
                    <p className='font-poppins font-normal text-[16px] sm:text-[18px] text-gray-400 text-left'>At Insyllium, we are not just software developers; we are visionaries, architects, and partners in your digital journey. With a foundation built on innovation, expertise, and a relentless pursuit of excellence, we transcend the realm of conventional software development.</p>
                </motion.div>
                <motion.div className='w-full sm:w-[30%] bg-[#46a2aa] rounded-lg'
                 initial={{
                    x:300,
                    opacity:0,
                }}
            ...
            <div className='flex flex-col w-full my-20'>
                <div className='w-full flex flex-col'>
                    <motion.h1 className='font-poppins font-semibold text-[44px] max-w-[350px] text-gray-100 text-left'
                    initial={{
                        x:-200,
                        opacity:0,
                    }}
                ...
                <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 justify-center mt-8'>
                    {ourTeam.map((o,index)=>(
                        ...
                        <h1 className='font-poppins font-semibold text-[20px] max-w-[350px] text-gray-100 text-left mt-2'>{o?.name}</h1>
                        <p className='font-poppins font-normal text-[14px] text-gray-300 text-left'>{o?.role}</p>
                    </motion.div>
                    ))}
                </div>
            </div>
